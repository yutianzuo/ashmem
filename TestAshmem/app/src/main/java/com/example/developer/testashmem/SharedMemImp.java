...
public class SharedMemImp extends ISharedMem.Stub {
    ...
    public ParcelFileDescriptor getSharedMemFD(String name,
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        /// 中执行
                        int size = ShmLib.getShmemSize();
                        listener.onSuccess(size);
                        Log.e("aidlserver", "out params:" + size);
            ...
            listener.onFail(0, "Fail from Server"); /// for test
